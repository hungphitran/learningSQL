...
CREATE TABLE `flight_leg` (
  ...
  CONSTRAINT `flight_leg_ibfk_1` FOREIGN KEY (`Flight_number`) REFERENCES `flight` (`Flight_number`),
  CONSTRAINT `flight_leg_ibfk_2` FOREIGN KEY (`Departure_airport_code`) REFERENCES `airport` (`Airport_code`),
  CONSTRAINT `flight_leg_ibfk_3` FOREIGN KEY (`Arrival_airport_code`) REFERENCES `airport` (`Airport_code`)
