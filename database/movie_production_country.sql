...
CREATE TABLE `production_country` (
  ...
  CONSTRAINT `production_country_ibfk_1` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`movie_id`),
  CONSTRAINT `production_country_ibfk_2` FOREIGN KEY (`country_id`) REFERENCES `country` (`country_id`)
