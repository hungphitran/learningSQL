...
CREATE TABLE `movie_languages` (
  ...
  KEY `language_role_id` (`language_role_id`),
  CONSTRAINT `movie_languages_ibfk_1` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`movie_id`),
  CONSTRAINT `movie_languages_ibfk_2` FOREIGN KEY (`language_id`) REFERENCES `language` (`language_id`),
  CONSTRAINT `movie_languages_ibfk_3` FOREIGN KEY (`language_role_id`) REFERENCES `language_role` (`role_id`)
